...
namespace lm.tool
{
    public class EmailHelper
    {
        ...
        public EmailHelper(string server, string toMail,string fromMail, string subject, string emailBody, 
            string username, string password, string port, bool sslEnable, bool pwdCheckEnable,List<string> attachs)
        {
            try
            {
                ...
                {
                    attachs.ForEach(path => mMailMessage.Attachments.Add(new Attachment(path)));
                }
